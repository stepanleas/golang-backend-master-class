...
// Source: github.com/artellas/simple-bank/db/sqlc (interfaces: Store)
...
// DeleteAccout mocks base method.
func (m *MockStore) DeleteAccout(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAccout", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAccout indicates an expected call of DeleteAccout.
func (mr *MockStoreMockRecorder) DeleteAccout(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAccout", reflect.TypeOf((*MockStore)(nil).DeleteAccout), arg0, arg1)
}
